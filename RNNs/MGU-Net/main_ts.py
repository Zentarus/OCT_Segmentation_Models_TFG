...
def train_seg(args, train_result_path, train_loader, eval_loader):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        # train for one epoch
        loss, dice_train, dice_1, dice_2, dice_3, dice_4, dice_5, dice_6, dice_7, dice_8, dice_9, dice_10 = train(
            args, train_loader, model, criterion1, criterion2, optimizer, epoch
        )
        logger_nn.log('train_losses', float(loss), epoch)

        # evaluate on validation set
        dice_val, dice_11, dice_22, dice_33, dice_44, dice_55, dice_66, dice_77, dice_88, dice_99, dice_1010, dice_list = eval(
            'train', args, eval_loader, model, criterion1, criterion2
        )
        ...
        metrics_entry = {
            ...
            "dice_classes": {
                "class1_train": float(dice_1),
                "class1_val": float(dice_11),
                "class2_train": float(dice_2),
                "class2_val": float(dice_22),
                "class3_train": float(dice_3),
                "class3_val": float(dice_33),
                "class4_train": float(dice_4),
                "class4_val": float(dice_44),
                "class5_train": float(dice_5),
                "class5_val": float(dice_55),
                "class6_train": float(dice_6),
                "class6_val": float(dice_66),
                "class7_train": float(dice_7),
                "class7_val": float(dice_77),
                "class8_train": float(dice_8),
                "class8_val": float(dice_88),
                "class9_train": float(dice_9),
                "class9_val": float(dice_99),
                "class10_train": float(dice_10),
                "class10_val": float(dice_1010),
            },
